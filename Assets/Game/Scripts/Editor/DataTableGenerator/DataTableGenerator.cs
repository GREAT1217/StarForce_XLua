...
namespace Game.Editor.DataTableTools
{
    public sealed class DataTableGenerator
    {
        ...
        private const string CSharpCodePath = "Assets/Game/Scripts/Base/DataTable";
        private const string CSharpCodeTemplateFileName = "Assets/Game/Configs/Editor/DataTableCodeTemplate.txt";
