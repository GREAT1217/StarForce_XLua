...
namespace Game
{
    public class ProcedureHotfixManager : ProcedureBase
    {
        private bool m_ChangeProcedure;
        private Type m_ProcedureType;

        private Dictionary<string, ProcedureHotfixBase> m_HotfixProcedures = new Dictionary<string, ProcedureHotfixBase>();
        private ProcedureHotfixBase m_CurrentHotfixBase;
