...
namespace XLua.CSObjectWrap
{
    public class XLua_Gen_Initer_Register__
	{
        ...
        static void wrapInit0(LuaEnv luaenv, ObjectTranslator translator)
        {
            ...
            translator.DelayWrapLoader(typeof(Game.SoundExtension), GameSoundExtensionWrap.__Register);
...
namespace XLua
{
	...
	internal partial class InternalGlobals
    {
		...
		delegate System.Nullable<int> __GEN_DELEGATE22( UnityGameFramework.Runtime.SoundComponent soundComponent,  int musicId,  object userData);
		
		delegate void __GEN_DELEGATE23( UnityGameFramework.Runtime.SoundComponent soundComponent);
		
		delegate System.Nullable<int> __GEN_DELEGATE24( UnityGameFramework.Runtime.SoundComponent soundComponent,  int soundId,  Game.Entity bindingEntity,  object userData);
		
		delegate System.Nullable<int> __GEN_DELEGATE25( UnityGameFramework.Runtime.SoundComponent soundComponent,  int uiSoundId,  object userData);
		
		delegate bool __GEN_DELEGATE26( UnityGameFramework.Runtime.SoundComponent soundComponent,  string soundGroupName);
		
		delegate float __GEN_DELEGATE27( UnityGameFramework.Runtime.SoundComponent soundComponent,  string soundGroupName);
		
		delegate void __GEN_DELEGATE28( UnityGameFramework.Runtime.SoundComponent soundComponent,  string soundGroupName,  bool mute);
		
		delegate void __GEN_DELEGATE29( UnityGameFramework.Runtime.SoundComponent soundComponent,  string soundGroupName,  float volume);
		
		delegate System.Collections.IEnumerator __GEN_DELEGATE30( UnityEngine.CanvasGroup canvasGroup,  float alpha,  float duration);
		
		delegate System.Collections.IEnumerator __GEN_DELEGATE31( UnityEngine.UI.Slider slider,  float value,  float duration);
		
		delegate void __GEN_DELEGATE32( UnityGameFramework.Runtime.UIComponent uiComponent,  Game.UGuiForm uiForm);
		
		delegate bool __GEN_DELEGATE33( UnityGameFramework.Runtime.UIComponent uiComponent,  Game.UIFormId uiFormId,  string uiGroupName);
		
		delegate bool __GEN_DELEGATE34( UnityGameFramework.Runtime.UIComponent uiComponent,  int uiFormId,  string uiGroupName);
		
		delegate Game.UGuiForm __GEN_DELEGATE35( UnityGameFramework.Runtime.UIComponent uiComponent,  Game.UIFormId uiFormId,  string uiGroupName);
		
		delegate Game.UGuiForm __GEN_DELEGATE36( UnityGameFramework.Runtime.UIComponent uiComponent,  int uiFormId,  string uiGroupName);
		
		delegate System.Nullable<int> __GEN_DELEGATE37( UnityGameFramework.Runtime.UIComponent uiComponent,  Game.UIFormId uiFormId,  object userData);
		
		delegate System.Nullable<int> __GEN_DELEGATE38( UnityGameFramework.Runtime.UIComponent uiComponent,  int uiFormId,  object userData);
		
		delegate void __GEN_DELEGATE39( UnityGameFramework.Runtime.UIComponent uiComponent,  Game.DialogParams dialogParams);
		
		delegate void __GEN_DELEGATE40( UnityGameFramework.Runtime.UIComponent uiComponent,  string hotfixUIName,  int uiFormId,  object userData);
	    ...
	    static InternalGlobals()
		{
		    extensionMethodMap = new Dictionary<Type, IEnumerable<MethodInfo>>()
			{
				...
				{typeof(UnityGameFramework.Runtime.SoundComponent), new List<MethodInfo>(){
				  ...
				  new __GEN_DELEGATE22(Game.SoundExtension.PlayMusic)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
				  ...
				  new __GEN_DELEGATE23(Game.SoundExtension.StopMusic)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
				  ...
				  new __GEN_DELEGATE24(Game.SoundExtension.PlaySound)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
				  ...
				  new __GEN_DELEGATE25(Game.SoundExtension.PlayUISound)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
				  ...
				  new __GEN_DELEGATE26(Game.SoundExtension.IsMuted)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
				  ...
				  new __GEN_DELEGATE27(Game.SoundExtension.GetVolume)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
				  ...
				  new __GEN_DELEGATE28(Game.SoundExtension.Mute)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
				  ...
				  new __GEN_DELEGATE29(Game.SoundExtension.SetVolume)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
				...
				{typeof(UnityEngine.CanvasGroup), new List<MethodInfo>(){
				  ...
				  new __GEN_DELEGATE30(Game.UIExtension.FadeToAlpha)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
				...
				{typeof(UnityEngine.UI.Slider), new List<MethodInfo>(){
				  ...
				  new __GEN_DELEGATE31(Game.UIExtension.SmoothValue)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
				...
				{typeof(UnityGameFramework.Runtime.UIComponent), new List<MethodInfo>(){
				  ...
				  new __GEN_DELEGATE32(Game.UIExtension.CloseUIForm)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
				  ...
				  new __GEN_DELEGATE33(Game.UIExtension.HasUIForm)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
				  ...
				  new __GEN_DELEGATE34(Game.UIExtension.HasUIForm)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
				  ...
				  new __GEN_DELEGATE35(Game.UIExtension.GetUIForm)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
				  ...
				  new __GEN_DELEGATE36(Game.UIExtension.GetUIForm)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
				  ...
				  new __GEN_DELEGATE37(Game.UIExtension.OpenUIForm)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
				  ...
				  new __GEN_DELEGATE38(Game.UIExtension.OpenUIForm)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
				  ...
				  new __GEN_DELEGATE39(Game.UIExtension.OpenDialog)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
				  ...
				  new __GEN_DELEGATE40(Game.UIExtension.OpenXLuaForm)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
